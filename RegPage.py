...
dau="\033[1;31m[\033[1;37mVMT\033[1;31m] \033[1;37m╰─>  "
s3x=f"""\033[1;93m             
...
\033[1;31m────────────────────────────────────────────────────────────
\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;33mTOOL REG PAGE PRO5
\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=>ADMIN: \033[1;36mVũ Mạnh Tiến
\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;36mFB: \033[1;31m𝑽𝒖\033[1;32m𝑴𝒂𝒏𝒉\033[1;35m𝑻𝒊𝒆𝒏
\033[1;31m────────────────────────────────────────────────────────────"""
...
print (s3x)
dem = 0
ck = input ('\033[1;31m[\033[1;37mVM-TIẾN\033[1;31m] \033[1;37m=> \033[1;32mNhập Cookie Acc Reg Pro5: \033[1;33m')  
dl =input('\033[1;31m[\033[1;37mVM-TIẾN\033[1;31m] \033[1;37m=> \033[1;32mNhập Delay Reg Pro5: \033[1;33m')
print("\033[1;31m────────────────────────────────────────────────────────────")
def delay(dl):
...
while True:
    arrayho = ["Nguyễn", "Trần", "Lê", "Phạm", "Hoàng", "Huỳnh", "Bạch","Võ", "Vũ", "Phan", "Trương", "Kiều","Bùi", "Đặng", "Đỗ", "Ngô", "Hồ", "Dương", "Đinh", "Lều", "Lò", "Ma", "Uất", "Huỳnh", "Phí", "Nghiêm", "Tôn"]
    arraylot = ["Công", "Đức", "Duy", "Gia", "Anh", "Hồng", "Đinh", "Quốc", "Quỳnh", "Vĩnh", "Lệ", "Ba", "Thị", "Bá", "Vương", "Hữu", "Văn" , "Hà", "Minh", "Ngọc", "Minh" , "Ngộ"]
    arrayten = ["Hưng", "Duy", "Đăng", "Thúy","Khương","Lam", "Không","Linh", "Đạt","Trang", "Tiến","Tuấn", "Trâm", "Long","Trọng","Lâm", "Anh", "Văn", "Tuấn", "Hoàng", "Quốc", "Năm", "Giang", "Khang", "Dương", "Phúc", "Thiên", "Hùng", "Kiệt", "Châu", "Quỳnh", "Huệ", "Tuấn", "Khánh", "Trân", "Yên", "Lợi", "Danh", "Vinh", "Nhi", "Nhí", "Quốc", "Anh", "Danh", "Hân", "Giang", "Phán", "My", "Việt", "Triều", "Thọ", "Vân", "Thanh", "Quang" ,"Tú" , "Tiên"]
