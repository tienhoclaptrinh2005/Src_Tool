...
print('\033[1;33m  ║          🌺      TOOL BUFF VIEW TIKTOK        🌺        ║')
print('\033[1;35m •╚═════════════════════════☩══✦══☩═════════════════════════╝•')
...
class Zefoy:
    def __init__(self):
        ...
        url1=input("\033[1;33mNhập link video : ")
    ...
    def get_table(self, i = 1):
        ...
        for service in self.services:
            ...
            i += 1
        table.title = f"{Fore.WHITE} Số Dịch Vụ Hoạt Động : {len([x for x in self.services_status if self.services_status[x]])}{Fore.RESET}"
        print(table)
        ...
        while True:
            ...
            if 'Session expired. Please re-login' in self.video_info:
                ...
                while time.time()-2<_+zefoy:
                    ...
                    print('\033[31m[VMT] 🍉 Vui lòng đợi 🍉 \033[1;32m{0}\033[31m '.format(t)+' Giây \033[1;32m',end='\r')
                    time.sleep(0.200)
                    print('\033[32m[VMT] 🍉 Vui lòng đợi 🍉 \033[1;32m{0}\033[31m '.format(t)+' Giây \033[1;32m',end='\r')
                    time.sleep(0.200)
                    print('\033[33m[VMT] 🍉 Vui lòng đợi 🍉 \033[1;32m{0}\033[31m '.format(t)+' Giây \033[1;32m',end='\r')
                    time.sleep(0.200)
                    print('\033[35m[VMT] 🍉 Vui lòng đợi 🍉 \033[1;32m{0}\033[31m '.format(t)+' Giây \033[1;32m',end='\r')
                    time.sleep(0.200)
                    print('\033[36m[VMT] 🍉 Vui lòng đợi 🍉 \033[1;32m{0}\033[31m '.format(t)+' Giây \033[1;32m',end='\r')
                    time.sleep(0.200)
    ...
    def select_service(self):
        while True:
            ...
            tim = "\033[1;35m"
            self.get_table()
            print(f"{xanh_la} Chọn:\033[1;37m:", end=' ')
            service_id = input()
